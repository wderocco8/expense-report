...
# echo "Creating DLQ..."
# awslocal sqs create-queue --queue-name receipts-dlq 2>/dev/null || echo "DLQ already exists"

# echo "Creating SQS queue with DLQ..."
# DLQ_ARN="arn:aws:sqs:us-east-2:000000000000:receipts-dlq"
...
# echo "Connecting SQS to Lambda with retry config..."
...
# echo "DLQ URL: http://localhost:4566/000000000000/receipts-dlq"