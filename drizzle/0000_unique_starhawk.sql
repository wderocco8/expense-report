...
--> statement-breakpoint
ALTER TABLE "extracted_expenses_table" ADD CONSTRAINT "extracted_expenses_table_job_id_expense_report_jobs_table_id_fk" FOREIGN KEY ("job_id") REFERENCES "public"."expense_report_jobs_table"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "receipt_files_table" ADD CONSTRAINT "receipt_files_table_job_id_expense_report_jobs_table_id_fk" FOREIGN KEY ("job_id") REFERENCES "public"."expense_report_jobs_table"("id") ON DELETE no action ON UPDATE no action;