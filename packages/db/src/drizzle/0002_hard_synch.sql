ALTER TYPE "public"."status" RENAME TO "receipt_status";--> statement-breakpoint
...
ALTER TABLE "receipt_files_table" RENAME COLUMN "processed_at" TO "extraction_completed_at";--> statement-breakpoint
ALTER TABLE "receipt_files_table" ALTER COLUMN "status" SET DATA TYPE text;--> statement-breakpoint
ALTER TABLE "receipt_files_table" ALTER COLUMN "status" SET DEFAULT 'pending'::text;--> statement-breakpoint
DROP TYPE "public"."receipt_status";--> statement-breakpoint
...
ALTER TABLE "receipt_files_table" ALTER COLUMN "status" SET DATA TYPE "public"."receipt_status" USING "status"::"public"."receipt_status";--> statement-breakpoint
...
ALTER TABLE "receipt_files_table" ADD COLUMN "ocr_completed_at" timestamp;--> statement-breakpoint
